...
export default {
  ...
  translation: {
    common: {
      ...
      areYouSureYouWantToDeleteThisCalendarEvent: '이 일정을 삭제하시겠습니까?',
      ...
      createCalendarEvent_title: '일정 만들기',
      ...
      deleteCalendarEvent_title: '일정 삭제',
      ...
      holidayApiEndpoint: '공휴일 API 주소',
      holidayInformationUnavailable: '현재 공휴일 정보를 사용할 수 없습니다.',
      holidays: '공휴일',
      host: '호스트',
      hours: '시간',
      identity: '신원',
      ...
      port: '포트',
      policy: '정책',
      policyPlaceholder: '컬럼 정책을 입력하세요...',
      preferences: '환경 설정',
      ...
      pullCriteria: 'Pull 기준',
      pullCriteriaPlaceholder: 'Pull 기준을 입력하세요...',
      ...
      wipLimitMode_warn_hint: 'WIP 한도를 초과하는 이동도 허용하되 경고를 표시합니다.',
      wipLimitMode_block: '초과 이동 차단 (하드 제한)',
      wipLimitMode_block_hint: 'WIP 한도를 초과하게 되는 이동을 거부합니다.',
      wipLimitExceeded: '컬럼 WIP 한도 초과. 이동이 차단되었습니다.',
