...
export default {
  ...
  translation: {
    common: {
      ...
      areYouSureYouWantToDeleteThisCalendarEvent: 'Are you sure you want to delete this event?',
      ...
      bufferColumn: 'Buffer Column',
      byCreationTime: 'By creation time',
      byDefault: 'By default',
      byDueDate: 'By due date',
      calendar: 'Calendar',
      calendarSettings_title: 'Calendar Settings',
      ...
      createCalendarEvent_title: 'Create Event',
      ...
      deleteCalendarEvent_title: 'Delete Event',
      ...
      editCalendarEvent_title: 'Edit Event',
      ...
      endCannotBeBeforeStart: 'End cannot be earlier than start.',
      ...
      holidayApiEndpoint: 'Holiday API endpoint',
      holidayInformationUnavailable: 'Holiday information is currently unavailable.',
      holidays: 'Holidays',
      host: 'Host',
      hours: 'Hours',
      identity: 'Identity',
      ...
      port: 'Port',
      policy: 'Policy',
      policyPlaceholder: 'Enter column policy...',
      ...
      pullCriteria: 'Pull Criteria',
      pullCriteriaPlaceholder: 'Enter pull criteria...',
      ...
      wipLimitMode_warn: 'Warn only (soft limit)',
      wipLimitMode_warn_hint: 'Allow moves that exceed WIP limits, but show a warning.',
      wipLimitMode_block: 'Block exceeding moves (hard limit)',
      wipLimitMode_block_hint: 'Reject moves that would exceed any WIP limit.',
      wipLimitExceeded: 'Column WIP limit reached. Move blocked.',
