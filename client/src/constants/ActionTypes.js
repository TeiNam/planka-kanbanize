...
export default {
  ...
  SWIM_LANE_CREATE: 'SWIM_LANE_CREATE',
  SWIM_LANE_CREATE__SUCCESS: 'SWIM_LANE_CREATE__SUCCESS',
  SWIM_LANE_CREATE__FAILURE: 'SWIM_LANE_CREATE__FAILURE',
  SWIM_LANE_CREATE_HANDLE: 'SWIM_LANE_CREATE_HANDLE',
  SWIM_LANE_UPDATE: 'SWIM_LANE_UPDATE',
  SWIM_LANE_UPDATE__SUCCESS: 'SWIM_LANE_UPDATE__SUCCESS',
  SWIM_LANE_UPDATE__FAILURE: 'SWIM_LANE_UPDATE__FAILURE',
  SWIM_LANE_UPDATE_HANDLE: 'SWIM_LANE_UPDATE_HANDLE',
  SWIM_LANE_SORT: 'SWIM_LANE_SORT',
  SWIM_LANE_SORT__SUCCESS: 'SWIM_LANE_SORT__SUCCESS',
  SWIM_LANE_SORT__FAILURE: 'SWIM_LANE_SORT__FAILURE',
  SWIM_LANE_DELETE: 'SWIM_LANE_DELETE',
  SWIM_LANE_DELETE__SUCCESS: 'SWIM_LANE_DELETE__SUCCESS',
  SWIM_LANE_DELETE__FAILURE: 'SWIM_LANE_DELETE__FAILURE',
  SWIM_LANE_DELETE_HANDLE: 'SWIM_LANE_DELETE_HANDLE',

  /* Calendar Events */

  CALENDAR_EVENT_CREATE: 'CALENDAR_EVENT_CREATE',
  CALENDAR_EVENT_CREATE__SUCCESS: 'CALENDAR_EVENT_CREATE__SUCCESS',
  CALENDAR_EVENT_CREATE__FAILURE: 'CALENDAR_EVENT_CREATE__FAILURE',
  CALENDAR_EVENT_CREATE_HANDLE: 'CALENDAR_EVENT_CREATE_HANDLE',
  CALENDAR_EVENT_UPDATE: 'CALENDAR_EVENT_UPDATE',
  CALENDAR_EVENT_UPDATE__SUCCESS: 'CALENDAR_EVENT_UPDATE__SUCCESS',
  CALENDAR_EVENT_UPDATE__FAILURE: 'CALENDAR_EVENT_UPDATE__FAILURE',
  CALENDAR_EVENT_UPDATE_HANDLE: 'CALENDAR_EVENT_UPDATE_HANDLE',
  CALENDAR_EVENT_DELETE: 'CALENDAR_EVENT_DELETE',
  CALENDAR_EVENT_DELETE__SUCCESS: 'CALENDAR_EVENT_DELETE__SUCCESS',
  CALENDAR_EVENT_DELETE__FAILURE: 'CALENDAR_EVENT_DELETE__FAILURE',
  CALENDAR_EVENT_DELETE_HANDLE: 'CALENDAR_EVENT_DELETE_HANDLE',

  /* Commitment Points */

  COMMITMENT_POINT_CREATE: 'COMMITMENT_POINT_CREATE',
  COMMITMENT_POINT_CREATE__SUCCESS: 'COMMITMENT_POINT_CREATE__SUCCESS',
  COMMITMENT_POINT_CREATE__FAILURE: 'COMMITMENT_POINT_CREATE__FAILURE',
  COMMITMENT_POINT_CREATE_HANDLE: 'COMMITMENT_POINT_CREATE_HANDLE',
  COMMITMENT_POINT_UPDATE: 'COMMITMENT_POINT_UPDATE',
  COMMITMENT_POINT_UPDATE__SUCCESS: 'COMMITMENT_POINT_UPDATE__SUCCESS',
  COMMITMENT_POINT_UPDATE__FAILURE: 'COMMITMENT_POINT_UPDATE__FAILURE',
  COMMITMENT_POINT_UPDATE_HANDLE: 'COMMITMENT_POINT_UPDATE_HANDLE',
  COMMITMENT_POINT_DELETE: 'COMMITMENT_POINT_DELETE',
  COMMITMENT_POINT_DELETE__SUCCESS: 'COMMITMENT_POINT_DELETE__SUCCESS',
  COMMITMENT_POINT_DELETE__FAILURE: 'COMMITMENT_POINT_DELETE__FAILURE',
  COMMITMENT_POINT_DELETE_HANDLE: 'COMMITMENT_POINT_DELETE_HANDLE',

  /* Classes of Service */

  CLASS_OF_SERVICE_CREATE: 'CLASS_OF_SERVICE_CREATE',
  CLASS_OF_SERVICE_CREATE__SUCCESS: 'CLASS_OF_SERVICE_CREATE__SUCCESS',
  CLASS_OF_SERVICE_CREATE__FAILURE: 'CLASS_OF_SERVICE_CREATE__FAILURE',
  CLASS_OF_SERVICE_CREATE_HANDLE: 'CLASS_OF_SERVICE_CREATE_HANDLE',
  CLASS_OF_SERVICE_UPDATE: 'CLASS_OF_SERVICE_UPDATE',
  CLASS_OF_SERVICE_UPDATE__SUCCESS: 'CLASS_OF_SERVICE_UPDATE__SUCCESS',
  CLASS_OF_SERVICE_UPDATE__FAILURE: 'CLASS_OF_SERVICE_UPDATE__FAILURE',
  CLASS_OF_SERVICE_UPDATE_HANDLE: 'CLASS_OF_SERVICE_UPDATE_HANDLE',
  CLASS_OF_SERVICE_DELETE: 'CLASS_OF_SERVICE_DELETE',
  CLASS_OF_SERVICE_DELETE__SUCCESS: 'CLASS_OF_SERVICE_DELETE__SUCCESS',
  CLASS_OF_SERVICE_DELETE__FAILURE: 'CLASS_OF_SERVICE_DELETE__FAILURE',
  CLASS_OF_SERVICE_DELETE_HANDLE: 'CLASS_OF_SERVICE_DELETE_HANDLE',

  /* Blockers */

  BLOCKER_CREATE: 'BLOCKER_CREATE',
  BLOCKER_CREATE__SUCCESS: 'BLOCKER_CREATE__SUCCESS',
  BLOCKER_CREATE__FAILURE: 'BLOCKER_CREATE__FAILURE',
  BLOCKER_CREATE_HANDLE: 'BLOCKER_CREATE_HANDLE',
  BLOCKER_UPDATE: 'BLOCKER_UPDATE',
  BLOCKER_UPDATE__SUCCESS: 'BLOCKER_UPDATE__SUCCESS',
  BLOCKER_UPDATE__FAILURE: 'BLOCKER_UPDATE__FAILURE',
  BLOCKER_UPDATE_HANDLE: 'BLOCKER_UPDATE_HANDLE',
  BLOCKER_LINKED_CARD_CREATE: 'BLOCKER_LINKED_CARD_CREATE',
  BLOCKER_LINKED_CARD_CREATE__SUCCESS: 'BLOCKER_LINKED_CARD_CREATE__SUCCESS',
  BLOCKER_LINKED_CARD_CREATE__FAILURE: 'BLOCKER_LINKED_CARD_CREATE__FAILURE',
  BLOCKER_LINKED_CARD_CREATE_HANDLE: 'BLOCKER_LINKED_CARD_CREATE_HANDLE',
  BLOCKER_LINKED_CARD_DELETE: 'BLOCKER_LINKED_CARD_DELETE',
  BLOCKER_LINKED_CARD_DELETE__SUCCESS: 'BLOCKER_LINKED_CARD_DELETE__SUCCESS',
  BLOCKER_LINKED_CARD_DELETE__FAILURE: 'BLOCKER_LINKED_CARD_DELETE__FAILURE',
  BLOCKER_LINKED_CARD_DELETE_HANDLE: 'BLOCKER_LINKED_CARD_DELETE_HANDLE',
  BLOCKER_DELETE: 'BLOCKER_DELETE',
  BLOCKER_DELETE__SUCCESS: 'BLOCKER_DELETE__SUCCESS',
  BLOCKER_DELETE__FAILURE: 'BLOCKER_DELETE__FAILURE',
  BLOCKER_DELETE_HANDLE: 'BLOCKER_DELETE_HANDLE',

  /* Card Relationships */

  CARD_RELATIONSHIP_CREATE: 'CARD_RELATIONSHIP_CREATE',
  CARD_RELATIONSHIP_CREATE__SUCCESS: 'CARD_RELATIONSHIP_CREATE__SUCCESS',
  CARD_RELATIONSHIP_CREATE__FAILURE: 'CARD_RELATIONSHIP_CREATE__FAILURE',
  CARD_RELATIONSHIP_CREATE_HANDLE: 'CARD_RELATIONSHIP_CREATE_HANDLE',
  CARD_RELATIONSHIP_SORT: 'CARD_RELATIONSHIP_SORT',
  CARD_RELATIONSHIP_SORT__SUCCESS: 'CARD_RELATIONSHIP_SORT__SUCCESS',
  CARD_RELATIONSHIP_SORT__FAILURE: 'CARD_RELATIONSHIP_SORT__FAILURE',
  CARD_RELATIONSHIP_DELETE: 'CARD_RELATIONSHIP_DELETE',
  CARD_RELATIONSHIP_DELETE__SUCCESS: 'CARD_RELATIONSHIP_DELETE__SUCCESS',
  CARD_RELATIONSHIP_DELETE__FAILURE: 'CARD_RELATIONSHIP_DELETE__FAILURE',
  CARD_RELATIONSHIP_DELETE_HANDLE: 'CARD_RELATIONSHIP_DELETE_HANDLE',

  /* Decorators */

  DECORATOR_CREATE: 'DECORATOR_CREATE',
  DECORATOR_CREATE__SUCCESS: 'DECORATOR_CREATE__SUCCESS',
  DECORATOR_CREATE__FAILURE: 'DECORATOR_CREATE__FAILURE',
  DECORATOR_CREATE_HANDLE: 'DECORATOR_CREATE_HANDLE',
  DECORATOR_UPDATE: 'DECORATOR_UPDATE',
  DECORATOR_UPDATE__SUCCESS: 'DECORATOR_UPDATE__SUCCESS',
  DECORATOR_UPDATE__FAILURE: 'DECORATOR_UPDATE__FAILURE',
  DECORATOR_UPDATE_HANDLE: 'DECORATOR_UPDATE_HANDLE',
  DECORATOR_DELETE: 'DECORATOR_DELETE',
  DECORATOR_DELETE__SUCCESS: 'DECORATOR_DELETE__SUCCESS',
  DECORATOR_DELETE__FAILURE: 'DECORATOR_DELETE__FAILURE',
  DECORATOR_DELETE_HANDLE: 'DECORATOR_DELETE_HANDLE',

  /* Card Decorators */

  CARD_DECORATOR_CREATE: 'CARD_DECORATOR_CREATE',
  CARD_DECORATOR_CREATE__SUCCESS: 'CARD_DECORATOR_CREATE__SUCCESS',
  CARD_DECORATOR_CREATE__FAILURE: 'CARD_DECORATOR_CREATE__FAILURE',
  CARD_DECORATOR_CREATE_HANDLE: 'CARD_DECORATOR_CREATE_HANDLE',
  CARD_DECORATOR_DELETE: 'CARD_DECORATOR_DELETE',
  CARD_DECORATOR_DELETE__SUCCESS: 'CARD_DECORATOR_DELETE__SUCCESS',
  CARD_DECORATOR_DELETE__FAILURE: 'CARD_DECORATOR_DELETE__FAILURE',
  CARD_DECORATOR_DELETE_HANDLE: 'CARD_DECORATOR_DELETE_HANDLE',

  /* Metrics */

  METRICS_CFD_FETCH: 'METRICS_CFD_FETCH',
  METRICS_CFD_FETCH__SUCCESS: 'METRICS_CFD_FETCH__SUCCESS',
  METRICS_CFD_FETCH__FAILURE: 'METRICS_CFD_FETCH__FAILURE',
  METRICS_LEAD_TIME_FETCH: 'METRICS_LEAD_TIME_FETCH',
  METRICS_LEAD_TIME_FETCH__SUCCESS: 'METRICS_LEAD_TIME_FETCH__SUCCESS',
  METRICS_LEAD_TIME_FETCH__FAILURE: 'METRICS_LEAD_TIME_FETCH__FAILURE',
  METRICS_THROUGHPUT_FETCH: 'METRICS_THROUGHPUT_FETCH',
  METRICS_THROUGHPUT_FETCH__SUCCESS: 'METRICS_THROUGHPUT_FETCH__SUCCESS',
  METRICS_THROUGHPUT_FETCH__FAILURE: 'METRICS_THROUGHPUT_FETCH__FAILURE',
  METRICS_WIP_AGING_FETCH: 'METRICS_WIP_AGING_FETCH',
  METRICS_WIP_AGING_FETCH__SUCCESS: 'METRICS_WIP_AGING_FETCH__SUCCESS',
  METRICS_WIP_AGING_FETCH__FAILURE: 'METRICS_WIP_AGING_FETCH__FAILURE',
  METRICS_SUMMARY_FETCH: 'METRICS_SUMMARY_FETCH',
  METRICS_SUMMARY_FETCH__SUCCESS: 'METRICS_SUMMARY_FETCH__SUCCESS',
  METRICS_SUMMARY_FETCH__FAILURE: 'METRICS_SUMMARY_FETCH__FAILURE',
  BOARD_DAILY_SNAPSHOTS_FETCH__SUCCESS: 'BOARD_DAILY_SNAPSHOTS_FETCH__SUCCESS',
};
