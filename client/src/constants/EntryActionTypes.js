...
export default {
  ...
  CARDS_IMPORT_TO_CURRENT_BOARD: `${PREFIX}/CARDS_IMPORT_TO_CURRENT_BOARD`,
  ...
  SWIM_LANE_IN_CURRENT_BOARD_CREATE: `${PREFIX}/SWIM_LANE_IN_CURRENT_BOARD_CREATE`,
  SWIM_LANE_CREATE_HANDLE: `${PREFIX}/SWIM_LANE_CREATE_HANDLE`,
  SWIM_LANE_UPDATE: `${PREFIX}/SWIM_LANE_UPDATE`,
  SWIM_LANE_UPDATE_HANDLE: `${PREFIX}/SWIM_LANE_UPDATE_HANDLE`,
  SWIM_LANE_SORT: `${PREFIX}/SWIM_LANE_SORT`,
  SWIM_LANE_DELETE: `${PREFIX}/SWIM_LANE_DELETE`,
  SWIM_LANE_DELETE_HANDLE: `${PREFIX}/SWIM_LANE_DELETE_HANDLE`,

  /* Calendar Events */

  CALENDAR_EVENT_IN_CURRENT_PROJECT_CREATE: `${PREFIX}/CALENDAR_EVENT_IN_CURRENT_PROJECT_CREATE`,
  CALENDAR_EVENT_CREATE_HANDLE: `${PREFIX}/CALENDAR_EVENT_CREATE_HANDLE`,
  CALENDAR_EVENT_UPDATE: `${PREFIX}/CALENDAR_EVENT_UPDATE`,
  CALENDAR_EVENT_UPDATE_HANDLE: `${PREFIX}/CALENDAR_EVENT_UPDATE_HANDLE`,
  CALENDAR_EVENT_DELETE: `${PREFIX}/CALENDAR_EVENT_DELETE`,
  CALENDAR_EVENT_DELETE_HANDLE: `${PREFIX}/CALENDAR_EVENT_DELETE_HANDLE`,

  /* Commitment Points */

  COMMITMENT_POINT_IN_CURRENT_BOARD_CREATE: `${PREFIX}/COMMITMENT_POINT_IN_CURRENT_BOARD_CREATE`,
  COMMITMENT_POINT_CREATE_HANDLE: `${PREFIX}/COMMITMENT_POINT_CREATE_HANDLE`,
  COMMITMENT_POINT_UPDATE: `${PREFIX}/COMMITMENT_POINT_UPDATE`,
  COMMITMENT_POINT_UPDATE_HANDLE: `${PREFIX}/COMMITMENT_POINT_UPDATE_HANDLE`,
  COMMITMENT_POINT_DELETE: `${PREFIX}/COMMITMENT_POINT_DELETE`,
  COMMITMENT_POINT_DELETE_HANDLE: `${PREFIX}/COMMITMENT_POINT_DELETE_HANDLE`,

  /* Classes of Service */

  CLASS_OF_SERVICE_IN_CURRENT_BOARD_CREATE: `${PREFIX}/CLASS_OF_SERVICE_IN_CURRENT_BOARD_CREATE`,
  CLASS_OF_SERVICE_CREATE_HANDLE: `${PREFIX}/CLASS_OF_SERVICE_CREATE_HANDLE`,
  CLASS_OF_SERVICE_UPDATE: `${PREFIX}/CLASS_OF_SERVICE_UPDATE`,
  CLASS_OF_SERVICE_UPDATE_HANDLE: `${PREFIX}/CLASS_OF_SERVICE_UPDATE_HANDLE`,
  CLASS_OF_SERVICE_DELETE: `${PREFIX}/CLASS_OF_SERVICE_DELETE`,
  CLASS_OF_SERVICE_DELETE_HANDLE: `${PREFIX}/CLASS_OF_SERVICE_DELETE_HANDLE`,

  /* Blockers */

  BLOCKER_CREATE: `${PREFIX}/BLOCKER_CREATE`,
  BLOCKER_CREATE_HANDLE: `${PREFIX}/BLOCKER_CREATE_HANDLE`,
  BLOCKER_UPDATE: `${PREFIX}/BLOCKER_UPDATE`,
  BLOCKER_UPDATE_HANDLE: `${PREFIX}/BLOCKER_UPDATE_HANDLE`,
  BLOCKER_LINKED_CARD_CREATE: `${PREFIX}/BLOCKER_LINKED_CARD_CREATE`,
  BLOCKER_LINKED_CARD_CREATE_HANDLE: `${PREFIX}/BLOCKER_LINKED_CARD_CREATE_HANDLE`,
  BLOCKER_LINKED_CARD_DELETE: `${PREFIX}/BLOCKER_LINKED_CARD_DELETE`,
  BLOCKER_LINKED_CARD_DELETE_HANDLE: `${PREFIX}/BLOCKER_LINKED_CARD_DELETE_HANDLE`,
  BLOCKER_DELETE: `${PREFIX}/BLOCKER_DELETE`,
  BLOCKER_DELETE_HANDLE: `${PREFIX}/BLOCKER_DELETE_HANDLE`,

  /* Card Relationships */

  CARD_RELATIONSHIP_CREATE: `${PREFIX}/CARD_RELATIONSHIP_CREATE`,
  CARD_RELATIONSHIP_CREATE_HANDLE: `${PREFIX}/CARD_RELATIONSHIP_CREATE_HANDLE`,
  CARD_RELATIONSHIP_SORT: `${PREFIX}/CARD_RELATIONSHIP_SORT`,
  CARD_RELATIONSHIP_DELETE: `${PREFIX}/CARD_RELATIONSHIP_DELETE`,
  CARD_RELATIONSHIP_DELETE_HANDLE: `${PREFIX}/CARD_RELATIONSHIP_DELETE_HANDLE`,

  /* Decorators */

  DECORATOR_IN_CURRENT_BOARD_CREATE: `${PREFIX}/DECORATOR_IN_CURRENT_BOARD_CREATE`,
  DECORATOR_CREATE_HANDLE: `${PREFIX}/DECORATOR_CREATE_HANDLE`,
  DECORATOR_UPDATE: `${PREFIX}/DECORATOR_UPDATE`,
  DECORATOR_UPDATE_HANDLE: `${PREFIX}/DECORATOR_UPDATE_HANDLE`,
  DECORATOR_DELETE: `${PREFIX}/DECORATOR_DELETE`,
  DECORATOR_DELETE_HANDLE: `${PREFIX}/DECORATOR_DELETE_HANDLE`,

  /* Card Decorators */

  CARD_DECORATOR_CREATE: `${PREFIX}/CARD_DECORATOR_CREATE`,
  CARD_DECORATOR_CREATE_HANDLE: `${PREFIX}/CARD_DECORATOR_CREATE_HANDLE`,
  CARD_DECORATOR_DELETE: `${PREFIX}/CARD_DECORATOR_DELETE`,
  CARD_DECORATOR_DELETE_HANDLE: `${PREFIX}/CARD_DECORATOR_DELETE_HANDLE`,

  /* Metrics */

  METRICS_CFD_FETCH: `${PREFIX}/METRICS_CFD_FETCH`,
  METRICS_LEAD_TIME_FETCH: `${PREFIX}/METRICS_LEAD_TIME_FETCH`,
  METRICS_THROUGHPUT_FETCH: `${PREFIX}/METRICS_THROUGHPUT_FETCH`,
  METRICS_WIP_AGING_FETCH: `${PREFIX}/METRICS_WIP_AGING_FETCH`,
  METRICS_SUMMARY_FETCH: `${PREFIX}/METRICS_SUMMARY_FETCH`,
